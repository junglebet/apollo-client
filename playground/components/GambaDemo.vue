...
const { result: data, refetch: refresh } = useQuery(gqlGames, { first: 5 }, { clientId: 'junglebet' })
const { onResult, onError, result, stop, start } = useSubscription(gqlLiveBet, null, { clientId: 'junglebet' })
